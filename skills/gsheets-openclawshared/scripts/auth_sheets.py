...
def main():
    ap = argparse.ArgumentParser(description="OAuth auth for Google Sheets + Drive readonly (folder restriction checks).")
    ...
    ap.add_argument("--port", type=int, default=18796, help="Local server port for OAuth redirect (tunnel flow)")
