...
# Need Docs scope to edit content; Drive readonly is used only to verify folder membership.
SCOPES = [
...
def main():
    ap = argparse.ArgumentParser(description="OAuth auth for Google Docs + Drive readonly (folder restriction checks).")
    ...
    ap.add_argument("--port", type=int, default=18795, help="Local server port for OAuth redirect (tunnel flow)")
